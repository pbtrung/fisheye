...
#define KE_ARX(x, xx, k, kk, s)                                                \
    do {                                                                       \
        x += k;                                                                \
        xx += x + kk;                                                          \
        x = ROL(x, s, TF_UNIT_BITS) ^ xx;                                      \
    } while (0)

#define BE_ARX(x, xx, s)                                                       \
    do {                                                                       \
        x += xx;                                                               \
        xx = ROL(xx, s, TF_UNIT_BITS) ^ x;                                     \
    } while (0)

#define KD_ARX(x, xx, k, kk, s)                                                \
    do {                                                                       \
        x ^= xx;                                                               \
        x = ROR(x, s, TF_UNIT_BITS);                                           \
        xx -= x + k;                                                           \
        x -= kk;                                                               \
    } while (0)
...
void tfc1024_encrypt_blk(tfc1024_ctx *ctx, const TF_UNIT_TYPE *input,
                         TF_UNIT_TYPE *output) {
#ifdef TF_FAST
    TF_UNIT_TYPE b0 = input[0], b1 = input[1], b2 = input[2], b3 = input[3],
                 b4 = input[4], b5 = input[5], b6 = input[6], b7 = input[7],
                 b8 = input[8], b9 = input[9], b10 = input[10], b11 = input[11],
                 b12 = input[12], b13 = input[13], b14 = input[14],
                 b15 = input[15];
    TF_UNIT_TYPE k0 = ctx->K[0], k1 = ctx->K[1], k2 = ctx->K[2], k3 = ctx->K[3],
                 k4 = ctx->K[4], k5 = ctx->K[5], k6 = ctx->K[6], k7 = ctx->K[7],
                 k8 = ctx->K[8], k9 = ctx->K[9], k10 = ctx->K[10],
                 k11 = ctx->K[11], k12 = ctx->K[12], k13 = ctx->K[13],
                 k14 = ctx->K[14], k15 = ctx->K[15], k16 = ctx->K[16];
    TF_UNIT_TYPE t0 = ctx->T[0], t1 = ctx->T[1], t2 = ctx->T[2];
#else
...
void tfc1024_decrypt_blk(tfc1024_ctx *ctx, const TF_UNIT_TYPE *input,
                         TF_UNIT_TYPE *output) {
#ifdef TF_FAST
    TF_UNIT_TYPE b0 = input[0], b1 = input[1], b2 = input[2], b3 = input[3],
                 b4 = input[4], b5 = input[5], b6 = input[6], b7 = input[7],
