...
/* ECB mode threefish. */
void tf1024_ecb_encrypt(tfc1024_ctx *ctx, const void *src, size_t slen, void *dst)
{
	const TF_BYTE_TYPE *usrc = src;
	TF_BYTE_TYPE *udst = dst;
	TF_UNIT_TYPE x[TF_BLOCK_UNITS], y[TF_BLOCK_UNITS];
...
void tf1024_ecb_decrypt(tfc1024_ctx *ctx, const void *src, size_t slen, void *dst)
{
	const TF_BYTE_TYPE *usrc = src;
	TF_BYTE_TYPE *udst = dst;
	TF_UNIT_TYPE x[TF_BLOCK_UNITS], y[TF_BLOCK_UNITS];
...
/* EME (Encrypt, Mask, Encrypt) mode. 2x slower. Has both CBC and CTR properties. */
void tf1024_eme_encrypt(tf1024_ctx *ctx, const void *src, size_t slen, void *dst)
{
	const TF_BYTE_TYPE *usrc = src;
	TF_BYTE_TYPE *udst = dst;
	TF_UNIT_TYPE x[TF_BLOCK_UNITS], y[TF_BLOCK_UNITS];
...
void tf1024_eme_decrypt(tf1024_ctx *ctx, const void *src, size_t slen, void *dst)
{
	const TF_BYTE_TYPE *usrc = src;
	TF_BYTE_TYPE *udst = dst;
	TF_UNIT_TYPE x[TF_BLOCK_UNITS], y[TF_BLOCK_UNITS];
